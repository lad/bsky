                    ...
                    [Argument('handle', nargs='?', help="user's handle"),
                     Argument('--flag', choices=['both',
                              ...
                              help="both show mutuals, follows-not-followers show "
                                   ...
                                   "follow back, followers-not-follows show users "
